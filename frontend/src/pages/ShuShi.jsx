...
import { IconSushi, IconFish, IconArrowRight } from '../components/GameIcons';
import { IconArrowLeft } from '../components/GameIcons';

const ShuShi = () => {
    return (
        <div className="min-h-[100dvh] bg-slate-900 text-white relative overflow-hidden font-sans flex flex-col">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center flex-grow p-4 text-center">
                ...
                <div className="absolute top-6 left-6">
                    <Link to="/" className="w-10 h-10 flex items-center justify-center bg-white/10 hover:bg-white/20 rounded-full backdrop-blur-md transition-colors">
                ...
                >
                    <div className="relative inline-block">
                        <h1 className="text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-cyan-400 drop-shadow-[0_0_15px_rgba(236,72,153,0.5)] tracking-tighter">
                            ShuShi
                        </h1>
                        <motion.div
                    ...
                    <p className="text-xl text-cyan-200 uppercase tracking-[0.2em] font-bold mt-2 text-shadow-glow">
                        Стань Суши-Мастером
                    </p>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="w-36 h-36 md:w-64 md:h-64 mb-6 relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl border border-white/10 flex items-center justify-center shadow-[0_0_40px_rgba(34,211,238,0.2)]"
                >
                    {/* Sushi Cat Placeholder */}
                    <div className="text-7xl">🐱🍣</div>

                    {/* Floating Elements */}
                    <motion.div animate={{ y: [-10, 10, -10] }} transition={{ repeat: Infinity, duration: 3 }} className="absolute -top-4 -right-4 bg-slate-800 p-3 rounded-2xl border border-white/10 shadow-xl">
                        <IconSushi className="w-8 h-8 text-red-400" />
                    </motion.div>
                    <motion.div animate={{ y: [10, -10, 10] }} transition={{ repeat: Infinity, duration: 4, delay: 1 }} className="absolute -bottom-4 -left-4 bg-slate-800 p-3 rounded-2xl border border-white/10 shadow-xl">
                        <IconFish className="w-8 h-8 text-orange-400" />
                    </motion.div>
                </motion.div>
                ...
                >
                    <Link to="/game/shushi/play" className="block w-full group relative">
                        ...
                        <button className="relative w-full bg-slate-900 rounded-2xl p-4 transition-all duration-200 group-hover:bg-slate-800 flex items-center justify-center gap-4 border border-white/10">
                            <span className="text-2xl font-black text-white uppercase tracking-widest group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-pink-400 group-hover:to-purple-400 transition-all">
                                Начать Игру
                            </span>
