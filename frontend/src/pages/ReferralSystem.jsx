    ...
    return (
        <div className="bg-slate-50 min-h-screen flex flex-col items-center relative overflow-hidden font-sans">
            ...
            <main className="max-w-4xl w-full z-10 flex flex-col md:flex-row gap-8 items-center justify-center p-4 mt-8">
                ...
                >
                    <div className="w-24 h-24 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-3xl flex items-center justify-center text-5xl mb-8 shadow-xl shadow-blue-200">
                        🤝
                    </div>
                    ...
                    <p className="text-gray-500 text-center text-lg leading-relaxed mb-10 max-w-sm">
                        Растите вместе! Приглашайте друзей в наше приложение и получайте эксклюзивные награды, купоны и VIP-статус за каждого активного реферала.
                    </p>

                    <div className="grid grid-cols-2 gap-4 w-full mb-10">
                        <div className="bg-blue-50/50 p-4 rounded-2xl border border-blue-100/50 text-center">
                            <p className="text-2xl font-black text-blue-600 mb-1">XP</p>
                        ...
                        <div className="bg-purple-50/50 p-4 rounded-2xl border border-purple-100/50 text-center">
                            <p className="text-2xl font-black text-purple-600 mb-1">VIP</p>
                            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Статус</p>
                        </div>
                    </div>
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={() => navigate('/game/referral/view')}
                        className="w-full py-5 rounded-2xl font-black text-white text-xl shadow-xl transition-all tracking-wide uppercase flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-indigo-600 hover:shadow-blue-200">
                        🚀 ПРИГЛАСИТЬ
                    </motion.button>
                </motion.div>
                ...
                <motion.div
                    initial={{ opacity: 0, x: 30 }}
                    animate={{ opacity: 1, x: 0 }}
                    className="flex-1 w-full hidden md:flex flex-col items-center justify-center p-8 bg-blue-600 rounded-[2.5rem] shadow-2xl relative overflow-hidden aspect-square"
                >
