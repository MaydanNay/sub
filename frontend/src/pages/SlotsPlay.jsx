...
const SlotsPlay = () => {
    ...
    return (
        <div className="bg-amber-50 min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
            {/* Decorative background */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-10 left-10 w-32 h-32 bg-yellow-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
                <div className="absolute top-10 right-10 w-32 h-32 bg-amber-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
                <div className="absolute bottom-10 left-1/2 w-48 h-48 bg-orange-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
            </div>
            ...
            <div className="absolute top-4 left-4 z-50">
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-white/50 backdrop-blur-md rounded-xl text-amber-900 font-bold hover:bg-white/80 transition-all"
                >
                    ← Назад
                </button>
            </div>
            ...
            <div className="flex flex-col items-center justify-center z-10 w-full max-w-md px-4">
                <h2 className="text-3xl font-black text-amber-900 mb-8 font-sans tracking-tight text-center">
                    🎰 Слоты
                </h2>
                ...
                <motion.div
                    ...
                    className="bg-gradient-to-b from-amber-600 to-amber-800 rounded-3xl p-6 shadow-2xl border-4 border-amber-400 w-full"
                >
                    {/* Reels */}
